                      ...
                      <tr>
                         ...
                         <td style="color: black " class=" pull-right">
                             ...
                             <div class="btn-group btn-group-justified">
                                <a  href="{{ route('reporte-order',$order) }}" style="color: white" type="button" class="btn btn-info"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title" id="defaultModalLabel">Reprogrammer la commande</h4>
                                    <button type="button" class="btn btn-light btn-circle dismiss" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true" class="material-icons">close</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    <form action="{{ route('reporte-order',$order) }}" method="POST">
                                        @method('PUT')
                                        @csrf
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-primary">Reprogrammer la commande</button>
                                </div>
                            </form>
                            </div>
                        </div>
