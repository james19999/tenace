...
@section('content')
    <div class="col-12 ">
        <div style="padding-top: 10px">
            <h3>Liste des commandes {{ $orders->count() }}</h4>
        </div>
                ...
                <form action="{{ route('repport-order') }}" method="GET">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-6 d-flex align-items-end">
                            <button class="btn btn-info" type="submit">Générer le rapport</button>
                        </div>
                    </div>
                </form>
                                    ...
                                    <td style="color: black " class=" pull-right">
                                        ...
                                        <div class="btn-group btn-group-justified">
                                            @if (Auth::user()->user_type == 'ADMINUSER')
                                                ...
                                                <a href="{{ route('check-type', $order) }}" style="color: white"
                                                    type="button"
                                                    class="btn b
                                   @if ($order->type == 'PR') btn-dark
                                   @else
