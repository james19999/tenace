     ...
     <div class="col-12 ">
         ...
         <div class="row mb-4">
             ...
             <div class="col-md-3" style="padding-top: 1%">
                 <input type="time" name="time" id="" value="{{ old('time') }}" placeholder="Heure"
                     class="form-control">
                 @error('time')
             ...
             <div class="col-md-3" style="padding-top: 1%">
                 <input type="number" name="tax" id="" value="{{ old('tax', 0) }}"
                     placeholder="Frais de livraison" class="form-control">
                 @error('tax')
                     <span class="text-danger">{{ $message }}</span>
                 @enderror
             </div>
             <div class="col-md-3" style="padding-top: 1%">
                 <button type="submit" style="color: white"
                     @if (Cart::instance('cart')->count() > 0) @else
                                         ...
                                         <td style="color: black " class=" pull-right">
                                             ...
                                             <div class="btn-group btn-group-justified">
                                                 ...
                                                 <button style="color: white" type="button" class="btn btn-warning"
                                                     @if ($items->model->qt_initial > $items->qty) wire:click.prevent="increment('{{ $items->rowId }}')"
