    ...
    <div class="row">
        ...
        <div class="col-md-6" style="padding-top: 2%">
           <button type="button" style="color: white" class="btn btn-success btn-block">
            Total  {{  $imprevus->sum('amount') }}  XOF  | Restant {{ $totalfons }} XOF</button>
        </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('retrait-imprevu') }}" method="POST">
                                    @csrf
        ...
        <div class="col-md-3" style="padding-top: 2%">
          <a href="{{ route('index-impre') }}" class="btn btn-info" >Liste des retraits  | {{ $totalretrait }} XOF</a>
         </div>
